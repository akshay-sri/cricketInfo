package com.cricket.project.services.Impl;

import com.cricket.project.entities.Cricket;
import com.cricket.project.repositories.CricketRepo;
...
//                update the match in database
    ...
    private void updateMatchInDB(Cricket match1) {
        Cricket match=this.cricketRepo.findByTeamHeading(match1.getTeamHeading()).orElse(null);
        if(match==null){
            cricketRepo.save(match1);
        }
        else{
